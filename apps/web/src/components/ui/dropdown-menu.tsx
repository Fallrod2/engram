...
const contentClasses =
  'z-50 min-w-[9rem] overflow-hidden rounded-md border border-border bg-surface-3 p-1 text-text shadow-md ' +
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      className={cn(itemClasses, 'data-[state=open]:bg-surface-2', inset && 'pl-8', className)}
      {...props}
    >
      {children}
