...
export const dictEn: Dict = {
  ...
  session: {
    ...
    quickAdd: 'Add',
    quickAddAria: 'Add a card without leaving the session',
    quickAddDialog: {
      title: 'New card',
      description:
        'It is born “new”: a future day’s new-card budget will serve it, not the session in progress.',
      deck: 'Deck',
      deckPlaceholder: 'Choose a deck…',
      deckLoading: 'Loading decks…',
      deckErrorFallback:
        'Could not load the deck list — the card will go to the deck of the card on screen.',
      deckError: 'Could not load the deck list.',
      archivedSuffix: '(archived)',
      noDecks: 'No deck can take a card.',
      done: 'Done',
      discardTitle: 'Discard this card?',
      discardDesc: 'The front and back you have just typed will be lost.',
  ...
  planning: {
    ...
    dateInputAria: 'Date (YYYY-MM-DD) — {date}',
  ...
  analytics: {
    ...
    retentionEmpty: 'No subject has enough mature reviews yet.',
    retentionHint_one: 'Retention appears from {count} mature review per subject.',
    retentionHint_other: 'Retention appears from {count} mature reviews per subject.',
    retentionRemaining_one: '{count} mature review to go',
    retentionRemaining_other: '{count} mature reviews to go',
    colSubject: 'Subject',
