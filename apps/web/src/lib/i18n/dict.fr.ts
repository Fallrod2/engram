...
export const dictFr = {
  ...
  shortcuts: {
    ...
    keys: {
      ...
      rate: 'Noter la carte',
      validateSuggested: 'Valider la note suggérée',
  ...
  analytics: {
    ...
    hardestTitle: 'Cartes les plus dures',
    hardestScope: 'état actuel',
    hardestError: 'Impossible de charger les cartes les plus dures.',
    hardestEmpty: 'Pas encore assez de révisions pour classer tes cartes.',
    hardestHint_one: 'Une carte entre au classement à partir de {count} review.',
    hardestHint_other: 'Une carte entre au classement à partir de {count} reviews.',
    hardestDifficultyAria: 'Difficulté de cette carte : {value} sur 10',
