...
export const dictFr = {
  ...
  cards: {
    ...
    colReps: 'Reps',
    truncated:
      'Affichage limité aux {limit} premières cartes sur {total}. Scindez ce deck pour tout consulter.',
  ...
  generation: {
    ...
    hintNoDeck: 'Choisissez un deck cible.',
    kbdGenerate: 'pour générer',
    history: 'Historique',
    historyEmpty: 'Aucune génération. Choisissez un type et un deck, puis Générer.',
    ...
    insertConfirmDesc: 'Elles deviendront dues immédiatement (état New).',
    insert: 'Insérer',
    inserting: 'Insertion…',
